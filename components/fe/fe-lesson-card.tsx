...
export function FeLessonCard({ lesson }: FeLessonCardProps) {
  return (
    <ClientNavigation
      ...
      className="group flex min-h-24 w-full items-center gap-4 rounded-lg border border-border bg-card p-4 text-left transition-colors hover:border-primary/35 hover:bg-accent/35 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:p-5"
    >
